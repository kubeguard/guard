...
var (
	pattern_Conduit_WhoAmI_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5, 2, 6}, []string{"_appscode", "api", "auth", "v1alpha1", "conduit", "whoami", "json"}, ""))

	pattern_Conduit_Users_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5, 2, 6}, []string{"_appscode", "api", "auth", "v1alpha1", "conduit", "users", "json"}, ""))
)
