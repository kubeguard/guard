...
func request_Credentials_Update_0(ctx context.Context, marshaler runtime.Marshaler, client CredentialsClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "type mismatch, parameter: %s, error: %v", "credential.metadata.name", err)
	}
...
func request_Clusters_Update_0(ctx context.Context, marshaler runtime.Marshaler, client ClustersClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "type mismatch, parameter: %s, error: %v", "cluster.metadata.name", err)
	}
...
func request_NodeGroups_Create_0(ctx context.Context, marshaler runtime.Marshaler, client NodeGroupsClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "type mismatch, parameter: %s, error: %v", "nodeGroup.metadata.clusterName", err)
	}
...
func request_NodeGroups_Update_0(ctx context.Context, marshaler runtime.Marshaler, client NodeGroupsClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "type mismatch, parameter: %s, error: %v", "nodeGroup.metadata.name", err)
	}
...
// RegisterCredentialsHandler registers the http handlers for service Credentials to "mux".
// The handlers forward requests to the grpc endpoint over the given implementation of "CredentialsClient".
...
// RegisterClustersHandler registers the http handlers for service Clusters to "mux".
// The handlers forward requests to the grpc endpoint over the given implementation of "ClustersClient".
...
func RegisterNodeGroupsHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterNodeGroupsHandlerClient(ctx, mux, NewNodeGroupsClient(conn))
}

// RegisterNodeGroupsHandler registers the http handlers for service NodeGroups to "mux".
// The handlers forward requests to the grpc endpoint over the given implementation of "NodeGroupsClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "NodeGroupsClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "NodeGroupsClient" to call the correct interceptors.
...
func RegisterSSHConfigHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterSSHConfigHandlerClient(ctx, mux, NewSSHConfigClient(conn))
}

// RegisterSSHConfigHandler registers the http handlers for service SSHConfig to "mux".
// The handlers forward requests to the grpc endpoint over the given implementation of "SSHConfigClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "SSHConfigClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "SSHConfigClient" to call the correct interceptors.
