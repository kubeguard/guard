...
func request_Metadata_ServerInfo_0(ctx context.Context, marshaler runtime.Marshaler, client MetadataClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterMetadataHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MetadataClient) error {
	...
	mux.Handle("GET", pattern_Metadata_ServerInfo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Metadata_ServerInfo_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Metadata_ServerInfo_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Metadata_ServerInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5, 2, 6}, []string{"_appscode", "api", "ci", "v1beta1", "metadata", "server-info", "json"}, ""))
)

var (
	forward_Metadata_ServerInfo_0 = runtime.ForwardResponseMessage
)
